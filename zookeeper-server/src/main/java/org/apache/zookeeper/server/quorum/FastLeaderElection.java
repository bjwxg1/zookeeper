...
public class FastLeaderElection implements Election {
    ...
    protected class Messenger {
        ...
        class WorkerReceiver extends ZooKeeperThread  {
            ...
            public void run() {
                ...
                while (!stop) {
                    // Sleeps on receive
                    try {
                        //从manager的RecvQueue获取投票信息[response]
                         ...
                         */
                        //判断从response解析的sid是否是有效的投票者，
                        // 如果不是将当前机器的投票信息发送[只是添加到sendqueue]
                        if(!validVoter(response.sid)) {
                             ...
                             */
                            //判断当前机器状态是否为Looking状态，将Notification添加到recvqueue
         ...
         */
        //从ToSender队列获取ToSend消息转化为requestBuffer添加到manager的待发送队列
     ...
     */
    private boolean checkLeader(Map<Long, Vote> votes, long leader, long electionEpoch){
    ...
    public Vote lookForLeader() throws InterruptedException {
        ...
        try {
            ...
            while ((self.getPeerState() == ServerState.LOOKING) && (!stop)){
                 ...
                 */
                if(n == null){
                    //如果获取notification为空，判断消息是否已经发送，如果已经发送完成进行重新发送
                ...
                //判断是否是有效的投票
                    ...
                    case LOOKING:
                        ...
                        //如果notification的electionEpoch大于当前机器的logicalclock。
                        ...
                        if (n.electionEpoch > logicalclock.get()) {
                            ...
                            //为什么此处没有处理？因为已经在WorkerReceiver中进行处理
                            if(LOG.isDebugEnabled()){
                        ...
                        //判断是否达到半数以上，如果返回True表示选举完成
                        if (voteSet.hasAllQuorums()) {
                            // Verify if there is any change in the proposed leader
                            //判断是否有更新的选票，如果有进入循环继续选举
                    ...
                    case LEADING:
                        ...
                        if(n.electionEpoch == logicalclock.get()){
                            recvset.put(n.sid, new Vote(n.leader, n.zxid, n.electionEpoch, n.peerEpoch));
                            voteSet = getVoteTracker(recvset, new Vote(n.leader, n.zxid, n.electionEpoch, n.peerEpoch, n.state));
                        ...
                        voteSet = getVoteTracker(outofelection, new Vote(n.leader, IGNOREVALUE, IGNOREVALUE, n.peerEpoch, n.state));
                        if (voteSet.hasAllQuorums() && checkLeader(outofelection, n.leader, IGNOREVALUE)) {
                            synchronized(this){
                                logicalclock.set(n.electionEpoch);
                                setPeerState(n.leader, voteSet);
                            }
